...
Revision ID: ace5a887137a
Revises: 
Create Date: 2024-04-24 12:46:33.196785
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_capec_typical_severity'), 'capec', ['typical_severity'], unique=False)
    op.create_table('cpe',
    ...
    op.create_index(op.f('ix_cpe_padded_version'), 'cpe', ['padded_version'], unique=False)
    ...
    op.create_index(op.f('ix_cves_lastModified'), 'cves', ['lastModified'], unique=False)
